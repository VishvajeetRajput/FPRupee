...
public class GovtInstituteUpdateRequest {
	...
	@Pattern(regexp = "^[A-Za-z0-9@#]*$", message = "deapartmentPassword must be in this   ")
	@NotBlank(message = "deapartmentContactNo Can not be empty")
	@Size(min = 10, max = 30, message = "deapartmentPassword must be between 1 to 50 words")
